...
<div class="container">
    <div class="insert text-center">
        <h2 style="margin: 20px 0;">UPDATE PRODUCT</h2>
        <c:set value="${sessionScope.detailP}" var="dp"></c:set>
        <form action="updatepro?pname=${dp.name}" method="POST" >
            <input type="text" class="text-center" style="border: 2px solid black; border-radius: 10px; padding: 4px 15px; width: 40%; margin: 0 0 10px;" 
                   placeholder="Name" name="name" value="${dp.name}" required=""><br>  
            <input type="url" class="text-center" style="border: 2px solid black; border-radius: 10px; padding: 4px 15px; width: 40%; margin: 0 0 10px;"
                   placeholder="Image" name="img" value="${dp.image}" required=""><br> 
            <input type="text" class="text-center" style="border: 2px solid black; border-radius: 10px; padding: 4px 15px; width: 40%; margin: 0 0 10px;" 
                   placeholder="Price" name="price" value="${dp.money}" required=""><br>  
            <input type="text" class="text-center" style="border: 2px solid black; border-radius: 10px; padding: 4px 15px; width: 40%; margin: 0 0 10px;"
                   placeholder="Title" name="title" value="${dp.title}" required=""><br>
            <input type="text" class="text-center" style="border: 2px solid black; border-radius: 10px; padding: 4px 15px; width: 40%; margin: 0 0 10px;" 
                   placeholder="Description" name="des" value="${dp.description}" required=""><br>  
            ...
            <input type="text" class="text-center" style="border: 2px solid black; border-radius: 10px; padding: 4px 15px; width: 40%; margin: 0 0 10px;"
                   placeholder="Quantity" name="quantity" value="${dp.quantity}" required=""><br>
